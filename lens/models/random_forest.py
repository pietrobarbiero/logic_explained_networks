...
from lens.models.base import BaseClassifier, ClassifierNotTrainedError, BaseXModel
from lens.utils.base import tree_to_formula, NotAvailableError
from lens.utils.metrics import Metric, Accuracy


class XRandomForestClassifier(BaseClassifier, BaseXModel):
    """
